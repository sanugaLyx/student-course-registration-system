...
function buildSidebar() {
  ...
  const items = [
    ...
    {label:'Timetable',icon:'calendar_month',href:'timetable.html',roles:['STUDENT','LECTURER','DEAN']},
...
async function executeDelete() {
  ...
  const epMap = {student:'students',lecturer:'lecturers',course:'courses',enrollment:'enrollments',timetable:'timetable',dept:'departments'};
  try {
